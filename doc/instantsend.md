...
This mechanism has been integrated into Bitcore-Node-SafePe which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/safepepay/insight-api-safepe#web-socket-api](https://github.com/safepepay/insight-api-safepe#web-socket-api)
* API: [https://github.com/safepepay/insight-api-safepe#instantsend-transactions](https://github.com/safepepay/insight-api-safepe#instantsend-transactions)
