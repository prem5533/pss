...
This document provides guidelines for internationalization of the SafePe Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `safepe_en.ts` remains unchanged.
