...
Arguments:
    <base_directory> - The base directory of a SafePe Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The SafePe Core developers'
...
Arguments:
    <base_directory> - The base directory of SafePe Core source code repository.
"""
...
Arguments:
    <file> - A source file in the SafePe Core repository.
"""
