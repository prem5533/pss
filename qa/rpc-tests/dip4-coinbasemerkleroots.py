...
from test_framework.test_framework import SafePeTestFramework
...
class LLMQCoinbaseCommitmentsTest(SafePeTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as SafePeTestFramework doesn't support this atm)
