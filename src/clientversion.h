...
//! These need to be macros, as clientversion.cpp's and safepe*-res.rc's voodoo requires it
...
/**
 * safeped-res.rc includes this file, but it cannot cope with real c++ code.
