...
#define BOOST_TEST_MODULE SafePe Test Suite

#include "test_safepe.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_safepe_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
