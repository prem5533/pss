...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if (fLiteMode) return; // ignore all SafePe related functionality
...
/*
    ...
    allow endless transaction that would bloat SafePe and make it unusable. To
...
{
    if (fLiteMode) return;        // disable all SafePe specific functionality
