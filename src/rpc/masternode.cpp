...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner SafePe address\n"
            "  payee          - Print the masternode payout SafePe address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting SafePe address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "safepe",               "masternode",             &masternode,             true,  {} },
    { "safepe",               "masternodelist",         &masternodelist,         true,  {} },
    { "safepe",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "safepe",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
